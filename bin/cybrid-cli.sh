...
main() {
  ...
  AUTH_TOKEN=$(getOauthToken $CYBERARK_ADMIN_USER $CYBERARK_ADMIN_PWD)
...
startAuthentication() {
  ...
  $CURL --request POST					\
  --url $IDENTITY_TENANT_URL/Security/StartAuthentication	\
  --header 'Accept: */*'				\
...
advanceAuthentication() {
  ...
  $CURL --request POST					\
  --url $IDENTITY_TENANT_URL/Security/AdvanceAuthentication	\
  --header 'Accept: */*'				\
  --header 'Content-Type: application/json'		\
  --header 'X-IDAP-NATIVE-CLIENT: true'			\
  --data "$pkg"
...
listUsers() {
  ...
  $CURL --request POST					\
  	$IDENTITY_TENANT_URL/CDirectoryService/GetUsers	\
  --header 'Accept: */*'				\
  --header 'Content-Type: application/json'		\
...
createUser() {
  ...
  echo
  $CURL --request POST					\
  --url $IDENTITY_TENANT_URL/CDirectoryService/CreateUser	\
  --header 'Accept: */*'				\
  --header 'Content-Type: application/json'		\
  --header 'X-IDAP-NATIVE-CLIENT: true'			\
  --header "Authorization: Bearer $authTkn"		\
...
removeUser() {
  ...
  $CURL --request POST				\
  --url $IDENTITY_TENANT_URL/UserMgmt/RemoveUser 	\
  --header 'Accept: */*'			\
  --header 'Content-Type: application/json'	\
  --header 'X-IDAP-NATIVE-CLIENT: true'		\
  --header "Authorization: Bearer $authTkn"	\
...
setAttribute() {
  ...
  $CURL --request POST					\
  --url $IDENTITY_TENANT_URL/UserMgmt/ChangeUserAttributes	\
  --header 'Accept: */*'				\
  --header 'Content-Type: application/json'		\
  --header 'X-IDAP-NATIVE-CLIENT: true'			\
  --header "Authorization: Bearer $authTkn"		\
...
set -x
  $CURL --request POST                                          \
        --url $IDENTITY_TENANT_URL/OAuth2/GetMeta?serviceName=$appId	\
        --header 'Accept: */*'                                  \
        --header 'Content-Type: application/json'               \
...
getPubKeys() {
  ...
  $CURL --request POST                                          \
        --url $IDENTITY_TENANT_URL/OAuth2/keys/$appId			\
        --header 'Accept: */*'                                  \
        --header 'Content-Type: application/json'               \
        --data ''
}
...
getUserInfo() {
  ...
  $CURL --request POST						\
        --url $IDENTITY_TENANT_URL/CDirectoryService/GetUserByName	\
        --header 'Accept: */*'					\
        --header 'Content-Type: application/json'		\
