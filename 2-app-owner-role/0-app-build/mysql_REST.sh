...
export JWT=$(cat /var/run/secrets/tokens/conjur-token)
export AUTHN_JWT_ENDPOINT=$CONJUR_APPLIANCE_URL/authn-jwt/$CONJUR_AUTHENTICATOR_ID/$CONJUR_ACCOUNT/authenticate
